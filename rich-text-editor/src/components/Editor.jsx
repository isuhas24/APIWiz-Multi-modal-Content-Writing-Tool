...
// importing the utils
// util function that handles te paste event.
...
const Editor = () => {
  ...
  // state variable to trach the slash menu active index.
  ...
  const insertBlockAtCursor = (blockType) => {
    ...
    if (!selection.isCollapsed) {
        ...
        wrapper.classList.add("editor-block");
    ...
    if (blockType === "blockquote") {
      ...
      newElement.classList.add("editor-block");
  ...
  const handleKeyDown = (e) => {
    ...
    if (e.key === "Tab") {
        ...
        const selection = window.getSelection();
        // if no text selected just retun
        if (!selection) return;
  ...
  return (
    <div className="editor-container">
        {/* tool bar component with formating options */}
        ...
        {/* slash menu component displayed based on the passe d position. */}
        {showSlashMenu && (
            <SlashMenu
